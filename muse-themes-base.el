;;; muse-themes-base.el --- Base file for muse-themes -*- lexical-binding: t; -*-
;;; Commentary:

;;; Code:
(defvar muse-themes-base-faces
  '(;; --- custom faces -----------------------
    (muse-modeline-error
     :background (muse-darken red 0.25)
     :foreground base0
    ...
    (region               :background region     :foreground nil   :distant-foreground (muse-darken fg 0.2))
    ...
    (custom-saved             :foreground green :background (muse-blend green bg 0.2) :bold bold)
    (custom-comment           :foreground fg :background region)
    (custom-comment-tag       :foreground grey)
    (custom-modified          :foreground blue :background (muse-blend blue bg 0.2))
    ...
    (custom-invalid           :foreground red :background (muse-blend red bg 0.2))
    (custom-variable-obsolete :foreground grey :background bg)
    (custom-state             :foreground green :background (muse-blend green bg 0.2))
    ...
    ;; ediff
    (ediff-fine-diff-A    :background (muse-blend selection bg 0.7) :weight 'bold)
    (ediff-fine-diff-B    :inherit 'ediff-fine-diff-A)
    (ediff-fine-diff-C    :inherit 'ediff-fine-diff-A)
    (ediff-current-diff-A :background (muse-blend selection bg 0.3))
    ...
    (message-header-cc         :inherit 'message-header-to :foreground (muse-darken highlight 0.15))
    ...
    (all-the-icons-lred     :foreground (muse-lighten red 0.3))
    (all-the-icons-dred     :foreground (muse-darken red 0.3))
    (all-the-icons-green    :foreground green)
    (all-the-icons-lgreen   :foreground (muse-lighten green 0.3))
    (all-the-icons-dgreen   :foreground (muse-darken green 0.3))
    (all-the-icons-yellow   :foreground yellow)
    (all-the-icons-lyellow  :foreground (muse-lighten yellow 0.3))
    (all-the-icons-dyellow  :foreground (muse-darken yellow 0.3))
    (all-the-icons-blue     :foreground blue)
    (all-the-icons-blue-alt :foreground teal)
    (all-the-icons-lblue    :foreground (muse-lighten blue 0.3))
    (all-the-icons-dblue    :foreground dark-blue)
    (all-the-icons-maroon   :foreground magenta)
    (all-the-icons-lmaroon  :foreground (muse-lighten magenta 0.3))
    (all-the-icons-dmaroon  :foreground (muse-darken magenta 0.3))
    (all-the-icons-purple   :foreground violet)
    (all-the-icons-lpurple  :foreground (muse-lighten violet 0.3))
    (all-the-icons-dpurple  :foreground (muse-darken violet 0.3))
    (all-the-icons-cyan     :foreground cyan)
    (all-the-icons-cyan-alt :foreground cyan)
    (all-the-icons-lcyan    :foreground (muse-lighten cyan 0.3))
    (all-the-icons-dcyan    :foreground dark-cyan)
    (all-the-icons-pink     :foreground (muse-lighten red 0.35))
    (all-the-icons-lpink    :foreground (muse-lighten red 0.55))
    (all-the-icons-dpink    :foreground red)
    (all-the-icons-silver   :foreground (muse-lighten grey 0.45))
    (all-the-icons-lsilver  :foreground (muse-lighten grey 0.7))
    (all-the-icons-dsilver  :foreground (muse-lighten grey 0.1))
    ...
    (avy-lead-face-0
     ...
     (&dark  :background (muse-lighten highlight 0.3))
     (&light :background (muse-darken highlight 0.3)))
    (avy-lead-face-1
     (&all   :inherit 'avy-lead-face)
     (&dark  :background (muse-lighten highlight 0.6))
     (&light :background (muse-darken highlight 0.6)))
    (avy-lead-face-2
     (&all   :inherit 'avy-lead-face)
     (&dark  :background (muse-lighten highlight 0.9))
     (&light :background (muse-darken highlight 0.9)))
    ...
    (cfw:face-header             :foreground (muse-blend blue bg 0.8) :weight 'bold)
    (cfw:face-sunday             :foreground (muse-blend red bg 0.8)  :weight 'bold)
    (cfw:face-saturday           :foreground (muse-blend red bg 0.8)  :weight 'bold)
    ...
    (company-tooltip-search-selection :background (muse-darken selection 0.25))
    ...
    (diff-context
     (&dark  :foreground (muse-darken fg 0.12))
     (&light :foreground (muse-lighten fg 0.12)))
    ...
    ;; dired-subtree
    (dired-subtree-depth-1-face :background (muse-darken bg-alt 0.02))
    (dired-subtree-depth-2-face :background (muse-darken bg-alt 0.04))
    (dired-subtree-depth-3-face :background (muse-darken bg-alt 0.06))
    (dired-subtree-depth-4-face :background (muse-darken bg-alt 0.08))
    (dired-subtree-depth-5-face :background (muse-darken bg-alt 0.10))
    (dired-subtree-depth-6-face :background (muse-darken bg-alt 0.12))

    ;; diredfl
    (diredfl-autofile-name          :foreground base4)
    (diredfl-compressed-file-name   :foreground yellow)
    (diredfl-compressed-file-suffix :foreground (muse-blend orange bg 0.6))
    (diredfl-date-time              :foreground cyan :weight 'light)
    (diredfl-deletion               :foreground red :background (muse-blend red bg 0.2) :weight 'bold)
    (diredfl-deletion-file-name     :foreground red :background (muse-blend red bg 0.2))
    ...
    (diredfl-file-suffix            :foreground (muse-blend fg bg 0.6))
    (diredfl-flag-mark              :foreground yellow :background (muse-blend yellow bg 0.2) :weight 'bold)
    (diredfl-flag-mark-line         :background (muse-blend yellow bg 0.1))
    ...
    ;; muse-modeline
    (muse-modeline-eldoc-bar :background green)
    (muse-modeline-inactive-bar :background nil) ; transparent
    ...
    (erc-header-line :background (muse-darken bg-alt 0.15) :foreground highlight)
    ...
    (gnus-summary-high-ancient   :foreground (muse-lighten base5 0.2) :inherit 'italic)
    (gnus-summary-high-read      :foreground (muse-lighten fg 0.2))
    (gnus-summary-high-ticked    :foreground (muse-lighten magenta 0.2))
    (gnus-summary-high-unread    :foreground (muse-lighten green 0.2))
    (gnus-summary-low-ancient    :foreground (muse-darken base5 0.2) :inherit 'italic)
    (gnus-summary-low-read       :foreground (muse-darken fg 0.2))
    (gnus-summary-low-ticked     :foreground (muse-darken magenta 0.2))
    (gnus-summary-low-unread     :foreground (muse-darken green 0.2))
    ...
    ;; hideshow
    (+muse-folded-face :inherit 'font-lock-comment-face
                       :weight 'light
                       :background (muse-darken bg 0.125))
    ...
    (ivy-minibuffer-match-face-1
     :background nil
     :foreground (muse-lighten grey 0.14)
     :weight 'light)
    ...
    ;; ivy-posframe
    (ivy-posframe :background (muse-darken bg-alt 0.2))
    ...
    (muse-neotree-dir-face :foreground highlight)
    (muse-neotree-file-face :foreground base8)
    (muse-neotree-hidden-file-face :foreground comments)
    (muse-neotree-text-file-face :foreground fg)
    (muse-neotree-data-file-face :foreground violet)
    (muse-neotree-media-file-face :inherit 'muse-neotree-hidden-file-face)
    ...
    (lsp-ui-peek-header :foreground fg :background (muse-lighten bg 0.1) :bold bold)
    (lsp-ui-peek-selection :foreground bg :background blue :bold bold)
    (lsp-ui-peek-list :background (muse-darken bg 0.1))
    (lsp-ui-peek-peek :background (muse-darken bg 0.1))
    ...
    (magit-diff-added             :foreground (muse-darken green 0.2)  :background (muse-blend green bg 0.1))
    (magit-diff-added-highlight   :foreground green                    :background (muse-blend green bg 0.2) :weight 'bold)
    (magit-diff-base              :foreground (muse-darken orange 0.2) :background (muse-blend orange bg 0.1))
    (magit-diff-base-highlight    :foreground orange                   :background (muse-blend orange bg 0.2) :weight 'bold)
    (magit-diff-context           :foreground (muse-darken fg 0.4) :background bg)
    ...
    (magit-diff-hunk-heading           :foreground bg                    :background (muse-blend violet bg 0.3))
    (magit-diff-hunk-heading-highlight :foreground bg                    :background violet :weight 'bold)
    (magit-diff-removed                :foreground (muse-darken red 0.2) :background (muse-blend red base3 0.1))
    (magit-diff-removed-highlight      :foreground red                   :background (muse-blend red base3 0.2) :weight 'bold)
    ...
    (objed-hl        :inherit 'region :background (muse-blend region bg 0.5))
    ...
    (powerline-active1   :inherit 'mode-line :background (muse-lighten 'bg 0.025))
    (powerline-active2   :inherit 'mode-line :foreground base8 :background (muse-lighten 'bg 0.08))
    (powerline-inactive0 :inherit 'mode-line-inactive :background base2)
    (powerline-inactive1 :inherit 'mode-line-inactive :background (muse-lighten 'base2 0.02))
    (powerline-inactive2 :inherit 'mode-line-inactive :background (muse-lighten 'base2 0.04))
    ...
    ;; smerge-tool
    (smerge-lower :background (muse-blend green bg 0.2))
    (smerge-upper :background (muse-blend red base3 0.2))
    (smerge-base  :background (muse-blend blue bg 0.2))
    ...
    (tldr-introduction     :foreground (muse-blend blue bg 0.8) :weight 'semi-bold)
    ...
    ;; twittering-mode
    (twitter-divider  ; custom face in Muse Emacs
     (&light :underline `(:color ,(muse-lighten vertical-bar 0.2)))
     (&dark  :underline `(:color ,(muse-darken vertical-bar 0.2))))
    ...
    (font-latex-sectioning-3-face :foreground (muse-lighten blue 0.3)    :weight 'semi-bold)
    (font-latex-sectioning-4-face :foreground (muse-lighten magenta 0.3) :weight 'semi-bold)
    (font-latex-sectioning-5-face :foreground (muse-lighten violet 0.3)  :weight 'semi-bold)
    ...
    (notmuch-search-flagged-face             :foreground (muse-blend red base4 0.5))
    ...
    (outline-4 :foreground (muse-lighten blue 0.25)    :weight 'bold)
    (outline-5 :foreground (muse-lighten magenta 0.25) :weight 'bold)
    (outline-6 :foreground (muse-lighten blue 0.5)     :weight 'bold)
    (outline-7 :foreground (muse-lighten magenta 0.5)  :weight 'bold)
    (outline-8 :foreground (muse-lighten blue 0.8)     :weight 'bold)
    ...
    (org-agenda-date-today    :foreground (muse-lighten violet 0.4)   :weight 'ultra-bold)
    (org-agenda-date-weekend  :foreground (muse-darken violet 0.4)  :weight 'ultra-bold)
    (org-agenda-structure     :foreground fg :weight 'ultra-bold)
    (org-agenda-clocking      :background (muse-blend blue bg 0.2))
    (org-upcoming-deadline         :foreground (muse-blend fg bg 0.8))
    (org-upcoming-distant-deadline :foreground (muse-blend fg bg 0.5))
    ...
    (org-habit-ready-face          :weight 'bold :background (muse-blend blue bg-alt 0.5))
    (org-habit-ready-future-face   :weight 'bold :background (muse-blend blue bg-alt 0.3))
    (org-habit-alert-face          :weight 'bold :background (muse-blend yellow bg-alt 0.5))
    (org-habit-alert-future-face   :weight 'bold :background (muse-blend yellow bg-alt 0.3))
    (org-habit-overdue-face        :weight 'bold :background (muse-blend red bg-alt 0.5))
    (org-habit-overdue-future-face :weight 'bold :background (muse-blend red bg-alt 0.3))
    ...
    (typescript-jsdoc-type :foreground (muse-darken doc-comments 0.15))
    (typescript-jsdoc-value :foreground (muse-lighten doc-comments 0.15))
  ...
  "Faces for muse-themes.")

(defvar muse-themes-base-vars
  '((ansi-color-names-vector
     (vconcat (mapcar #'muse-color '(bg red green yellow blue magenta cyan fg))))

    (fci-rule-color (muse-color 'base5))

    (jdee-db-spec-breakpoint-face-colors `(cons ,(muse-color 'base0) ,(muse-color 'grey)))
    (jdee-db-requested-breakpoint-face-colors `(cons ,(muse-color 'base0) ,(muse-color 'green)))
    (jdee-db-active-breakpoint-face-colors `(cons ,(muse-color 'base0) ,(muse-color 'highlight)))

    (objed-cursor-color (muse-color 'red))

    (vc-annotate-color-map
     `(list (cons 20  ,(muse-color 'green))
            (cons 40  ,(muse-blend 'yellow 'green (/ 1.0 3)))
            (cons 60  ,(muse-blend 'yellow 'green (/ 2.0 3)))
            (cons 80  ,(muse-color 'yellow))
            (cons 100 ,(muse-blend 'orange 'yellow (/ 1.0 3)))
            (cons 120 ,(muse-blend 'orange 'yellow (/ 2.0 3)))
            (cons 140 ,(muse-color 'orange))
            (cons 160 ,(muse-blend 'magenta 'orange (/ 1.0 3)))
            (cons 180 ,(muse-blend 'magenta 'orange (/ 2.0 3)))
            (cons 200 ,(muse-color 'magenta))
            (cons 220 ,(muse-blend 'red 'magenta (/ 1.0 3)))
            (cons 240 ,(muse-blend 'red 'magenta (/ 2.0 3)))
            (cons 260 ,(muse-color 'red))
            (cons 280 ,(muse-blend 'grey 'red (/ 1.0 4)))
            (cons 300 ,(muse-blend 'grey 'red (/ 2.0 4)))
            (cons 320 ,(muse-blend 'grey 'red (/ 3.0 4)))
            (cons 340 ,(muse-color 'base5))
            (cons 360 ,(muse-color 'base5))))
    (vc-annotate-very-old-color nil)
    (vc-annotate-background (muse-color 'bg)))
  "Base variables for muse-themes.")

(provide 'muse-themes-base)
;;; muse-themes-base.el ends here
