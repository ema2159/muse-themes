;; muse-gruvbox-theme.el --- inspired by morhetz gruvbox
;;; Commentary:
;; Muse themes implementation of Gruvbox by Mohretz (thanks to JongW)
(require 'muse-themes)

;;; Code:

(defgroup muse-gruvbox-theme nil
  "Options for muse-gruvbox."
  :group 'muse-themes)

(defcustom muse-gruvbox-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'muse-gruvbox-theme
  :type 'boolean)

(defcustom muse-gruvbox-padded-modeline muse-themes-padded-modeline
...
;;
(def-muse-theme muse-gruvbox
  "Dark theme with pastel 'retro groove' colors."

  ;; name        gui       256       16
  ((bg         '("#282828" nil       nil          ))
   (bg-alt     '("#323232" nil       nil          ))
   ...
   (selection      accent)
   (builtin        orange)
   (comments       (if muse-gruvbox-brighter-comments magenta base5))
   ...
   (vc-modified    accent)
   (vc-added       (muse-darken green 0.15))
   (vc-deleted     red)

   ;; custom categories
   (-modeline-pad
    (when muse-gruvbox-padded-modeline
      (if (integerp muse-gruvbox-padded-modeline)
          muse-gruvbox-padded-modeline
        4)))

   (org-quote `(,(muse-lighten (car bg) 0.05) "#1f1f1f")))
...
(
   ...
   ;;;;;;;; Muse-modeline ;;;;;;;;
   (mode-line
    :background accent :foreground base5
   ...
   ;; File-name
   (muse-modeline-project-dir :bold t :foreground cyan)
   (muse-modeline-buffer-path :inherit 'bold :foreground green)
   (muse-modeline-buffer-file :inherit 'bold :foreground fg)
   (muse-modeline-buffer-modified :inherit 'bold :foreground yellow)
   ;; Misc
   (muse-modeline-error :background bg)
   (muse-modeline-buffer-major-mode :foreground green :bold t)
   (muse-modeline-warning :foreground red :bold t)
   (muse-modeline-info :bold t :foreground cyan)
   (muse-modeline-bar :background dark-green)
   (muse-modeline-panel :background dark-green :foreground fg)
   ...
   (muse-neotree-dir-face :foreground cyan)
   (neo-dir-link-face   :foreground cyan)
   (muse-neotree-file-face :foreground fg)
   (muse-neotree-hidden-file-face :foreground base5)
   (muse-neotree-media-file-face :foreground base5)
   ...
   ;; ediff
   (ediff-fine-diff-A :background (muse-blend red bg 0.3) :weight 'bold)
   ...
   (markdown-code-face :background (muse-lighten base2 0.045))
...
;;; muse-gruvbox-theme.el ends here
